...
define('OWA_DB_NAME', 'cl20-a-owa-j38'); // name of the database
define('OWA_DB_HOST', 'localhost'); // host name of the server housing the database
define('OWA_DB_USER', 'cl20-a-owa-j38'); // database user
define('OWA_DB_PASSWORD', 'XDgyhez^m'); // database user's password
...
define('OWA_PUBLIC_URL', 'http://mindsparksummer.com/analytics/');  
